...
(function () {
  ...
  function setChannelArt(i) {
    ...
    try {
      ...
      link.href = "assets/icons/favicon-" + col + "-48.png?v=103";
      document.head.appendChild(link);
    } catch (e) {}
    try {
      var badge = document.querySelector(".badge");
      if (badge) badge.style.backgroundImage = 'url("assets/icons/product-' + col + '-216.png?v=103")';
    } catch (e) {}
  }
  ...
  function ensureAbout() {
    ...
    aboutEl.innerHTML = '<div class="aboutsheet"><div class="cmphead"><span>About Me</span><button class="x" id="aboutClose">✕ close</button></div>' +
      '<div class="aboutbody">' +
      '<div class="aboutpic"><div class="apic-frame"><img src="assets/about-me.jpg?v=103" alt="DJ7 - Wilsonlicioussss" onerror="this.parentNode.classList.add(\'empty\');this.remove()"></div><span class="aname">DJ7 · Wilsonlicioussss</span></div>' +
  ...
  window.__GENOME = { nodes: nodes, links: links, byId: byId, select: select, centerOn: centerOn, version: "V103" };
})();
